...
> 카드·은행 결제 알림을 자동 감지해 가계부를 채우고, 이번 달 지출을 내 예산(수급일 사이클)과 비교해 과소비를 막아주는 안드로이드 앱

---

## 소개

내돈지켜는 사용자가 직접 지출을 입력하지 않아도 **카드 결제, 계좌 이체 등의 시스템 알림을 자동으로 감지**해 가계부를 채우는 안드로이드 앱입니다.
