        ...
        LazyColumn {
            ...
            item {
                AmSettingGroup(
                    ...
                    items = listOf(
                        {
                            AmSettingItem(title = "건의하기", subtitle = "devcoderblue@gmail.com", onClick = onFeedback) {
                                AmChevron()
                            }
                        },
                        {
                            AmSettingItem(title = "평가하기", subtitle = "플레이스토어에서 별점 남기기", onClick = onRate) {
                                AmChevron()
                            }
                        },
                        {
